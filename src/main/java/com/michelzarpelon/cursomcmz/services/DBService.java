...
public class DBService {
	...
	public void instantiateTesteDatabase() throws ParseException {
		...
		Categoria cat3 = new Categoria(3, "Cama Mesa Banho");
		Categoria cat4 = new Categoria(4, "Eletronicos");
		...
		cat1.getProdutos().addAll(Arrays.asList(p12, p13, p14, p15, p16, p17, p18, p19, p20,p21, p22, p23, p24, p25, p26, p27, p28, p29, p30, p31, p32, p34, p35, p36, p37, p38,
								  p39, p40, p41, p42, p43, p44, p45, p46, p47, p48, p49, p50,p1,p2,p3));
		...
		repositorioCategoria.save(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7));
		...
		Cliente cli1 = new Cliente(null, "Michel E. Zarpelon", "michelzarpe@gmail.com", "36378912377", TipoCliente.PESSOAFISICA,bCryptPasswordEncoder.encode("123"));
		cli1.getTelefone().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Michel Zarpelon", "michelzarpe@outlook.com", "07295295097", TipoCliente.PESSOAFISICA,bCryptPasswordEncoder.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefone().addAll(Arrays.asList("27311323", "99838393"));
		
		Endereco e3 = new Endereco(null, "Av. Floriano Peixoto", "9", "casa", "Centro", "38220834", cli2, c2);
